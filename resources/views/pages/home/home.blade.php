...
@section('content')
	<p class="home_intro col-sm-6 col-sm-offset-3">
		...
		<br>
		Добрата грижа за пациентите, постоянно обновяващата се база, апаратура и високоспециализиран персонал му отреждат водещо място сред лечебните заведения в Югозападна България. 
		<br>
